...
app.use(cors());
// Workspace state can include optional driver documents and business logos as
// data URLs. The default Express JSON limit (100 KB) rejects valid owner
// workspaces before the route handler gets a chance to process them.
